...
In development is the ability to use dplyr filter-like expressions on the virtual dimension
names to get a "transform object", a table for each of the axis position values. This is used
to  build "hyperslab" (array) queries for the NetCDF API, and then these two outputs can be combined in a table for simple analysis or visualization. There are some examples here: 
